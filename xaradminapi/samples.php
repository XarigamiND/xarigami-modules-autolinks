    ...
    $setuptypes = array(
        'autolink-types' => array(
                'autolink-type:tid:1' => array(
                    ...
                    'links' => array(
                        'link:lid:1' => array(
                            'name' => xarML('Xarigami home'),
                            'keyword' => 'xarigami[\'s]*',
                            'match_re' => '1',
                            'title' => 'Xarigami - Content Management System',
                            'url' => 'http://xarigami.com/',
                            'comment' => 'Xarigami home page.',
                            'enabled' => '1'
                        )
                    )
                ),
                ...
                'autolink-type:tid:3' => array(
                    ...
                    'links' => array(
                        'link:lid:1' => array(
                            ...
                            'keyword' => '(http://(?!demo.xarigami.com)[-.a-z]+/)[^\s.;?!]*',
                            'match_re' => '1',
                            'title' => 'Visit the site: $2',
                            'url' => '$1',
                            'comment' => 'Matches any URL to an external website home page. Does not match the current site (demo.xarigami.com in this example) - which is left up to other links to catch.',
                            'sample' => 'http://xarigami.com/ http://demo.xarigami.com/ http://xxx/abc/123',
                            'enabled' => '0',
                            'dd_properties' => array (
                                'imgalt' => '',
                                'icon' => 'icons/www-url.png',
                                'target' => 'external'
                            )
                        )
                    ),
                ...
                'autolink-type:tid:7' => array(
                    ...
                    'links' => array(
                        'link:lid:1' => array(
                            ...
                            'keyword' => '(http://(?!bugs.xarigami.com)[-.a-z]+/)[^\s.;?!]*',
                            'match_re' => '1',
                            'title' => 'Visit the site: $2',
                            'url' => '$1',
                            'comment' => 'Matches any URL to an external website home page. Does not match the current site (bugs.xarigami.com in this example) - which is left up to other links to catch.',
                            'sample' => 'http://xarigami.com/ http://bugs.xarigami.com/ http://xxx/abc/123',
                            'enabled' => '0'
                        )
                    ),
                ),
                ...
                'autolink-type:tid:8' => array(
                    ...
                    'links' => array(
                        'link:lid:1' => array(
                            ...
                            'sample' => 'mailto:xarigami@example.com mailto:fred@com',
                            'enabled' => '0'
                        )
                    ),
                )
